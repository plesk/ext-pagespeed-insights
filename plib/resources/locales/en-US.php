...
$messages = [
    ...
    'output_description_config'                     => 'You can adjust the Apache module configuration file for your needs. If you get an error message although your input was saved, then the Apache server could not be restarted due to a syntax error. In such a case, you should correct your input or restore the default configuration file.<br /><strong>Attention: Modify the file only if you know what you are doing!</strong>',
    'output_description_restore'                    => 'You can restore the default configuration file from the Apache module. This backup file was created during the first installation process.<br /><strong>Attention: All possible changes will be overwritten!</strong>',
    ...
    'tool_config_edit_description_not_installed'    => 'Install the Apache module first to be able to edit the configuration file.',
    ...
    'tool_config_restore_description_not_installed' => 'Install the Apache module first to be able to restore the configuration file.',
    'tool_config_restore_description'               => 'Restore the default configuration file of the Apache module.',
    'tool_config_file_custom'                       => '<strong>Custom configuration file is active.</strong>',
    'tool_config_file_default'                      => '<strong>Default configuration file is active.</strong>',
];
